...
var _require2 = require('timers');

const setTimeout = _require2.setTimeout;
...
module.exports = {
  ...
  readFile(fullPath) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (exist) {
        const content = yield new Promise(function (resolve, reject) {
  ...
  readDir(fullPath) {
    ...
    return _asyncToGenerator(function* () {
      const exist = yield _this4.exitsResource(fullPath);
      if (exist) {
        const content = yield new Promise(function (resolve, reject) {
  ...
  addFolderP(fullPath) {
    ...
    return _asyncToGenerator(function* () {
      ...
      while (!(yield _this5.exitsResource(currDir))) {
        dirs.push(currDir);
        currDir = path.dirname(currDir);
      }
      dirs = dirs.reverse();
